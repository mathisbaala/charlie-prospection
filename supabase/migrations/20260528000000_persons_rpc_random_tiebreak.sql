-- Amélioration search_persons_by_criteria :
-- Tri secondaire RANDOM() pour les profils à score identique.
-- Évite que les CGPs voient toujours les mêmes 50 personnes
-- quand plusieurs centaines ont le même quick-score (même profession, même département).
